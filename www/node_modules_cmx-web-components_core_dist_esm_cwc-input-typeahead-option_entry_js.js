"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_cmx-web-components_core_dist_esm_cwc-input-typeahead-option_entry_js"],{
...
/***/ 21820:
/*!********************************************************************************************!*\
  !*** ./node_modules/@cmx-web-components/core/dist/esm/cwc-input-typeahead-option.entry.js ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "cwc_input_typeahead_option": () => (/* binding */ InputTypeaheadOption)
/* harmony export */ });
...
const InputTypeaheadOption = class {
  constructor(hostRef) {
    ...
    /**
     * Selected prop for keyboard navigation
     */
    ...
    this.rtl = false;
    this.optionSelectedEvent = (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "cwcInputTypeaheadOptionSelected", 7);
    this.optionRegisteredEvent = (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "cwcInputTypeaheadOptionRegistered", 7);
    this.optionUnregisteredEvent = (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "cwcInputTypeaheadOptionUnregistered", 7);
  }
  /**
   * Hide option in the list - used in search filter
   */
  ...
  /**
   * Show option in the list - used in search filter
   */
  ...
  /**
   * Lifecycle hook - component did load
   */


  componentDidLoad() {
    this.optionRegisteredEvent.emit(this.host);
  }
  /**
   * Lifecycle hook - component did unload
   */


  disconnectedCallback() {
    this.optionUnregisteredEvent.emit(this.host);
    (0,_commonComponentFeatures_b771e888_js__WEBPACK_IMPORTED_MODULE_2__.d)(this);
  }

  onSelectOption() {
    const name = this.host.innerText;
    this.optionSelectedEvent.emit(name);
  }

  render() {
    return (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: `cwc-input-typeahead__option ${this.designVersion} ${this.hidden && 'hidden'} ${this.selected && 'selected'}`,
      onClick: this.onSelectOption.bind(this),
      role: "option"
  ...
  static get style() {
    return "*{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.cwc-input-typeahead__option{padding:.625rem 1rem;cursor:pointer;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}.cwc-input-typeahead__option.hidden{display:none}.cwc-input-typeahead__option.selected{background-color:var(--cwc-input-typehead-option-selected-background-color,var(--cwc-color-elements-bg,#f4f6f9))}\@media (hover:hover){.cwc-input-typeahead__option:hover{background-color:var(--cwc-input-typehead-option-hover-background-color,var(--cwc-color-elements-bg,#f4f6f9))}}";
  }
...
//# sourceMappingURL=node_modules_cmx-web-components_core_dist_esm_cwc-input-typeahead-option_entry_js.js.map