"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_cmx-web-components_core_dist_esm_cwc-input-number_entry_js"],{
...
/***/ 34335:
/*!**********************************************************************************!*\
  !*** ./node_modules/@cmx-web-components/core/dist/esm/cwc-input-number.entry.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "cwc_input_number": () => (/* binding */ InputNumberComponent)
/* harmony export */ });
...
var autoNumeric_min = (0,_commonjsHelpers_97e6d7b1_js__WEBPACK_IMPORTED_MODULE_3__.c)(function (module, exports) {
  /**
  ...
  !function (e, t) {
    module.exports = t();
  }(_commonjsHelpers_97e6d7b1_js__WEBPACK_IMPORTED_MODULE_3__.a, function () {
      ...
      var O,
        ...
        return t = [{
          ...
          value: function (e, t, i, n, a) {
            ...
            if ("" !== t.digitGroupSeparator) for (; o.test(h);) h = h.replace(o, "$1".concat(t.digitGroupSeparator, "$2"));
          ...
          value: function (e, t, i) {
            ...
            if (v = "." === e.charAt(c) ? e.charAt(c - 1) % 2 : e.charAt(c) % 2, this._shouldRoundUp(p, t, r, v)) for (var y = f.length - 1; 0 <= y; --y) if ("." !== f[y]) {
          ...
          value: function () {
            for (var e in this.settings) if (Object.prototype.hasOwnProperty.call(this.settings, e)) {
            ...
            if (e.preventDefault(), !(this.settings.readOnly || this.domElement.readOnly || this.domElement.disabled)) {
              ...
              switch ("" === y && "-" === S && (y = "-", w = !(S = "")), this.settings.onInvalidPaste) {
                ...
                case B.options.onInvalidPaste.replace:
                  ...
                  for (var _ = h, C = k.length; N < c.length && _ < C;) if ("." !== k[_]) {
...
const AutoNumeric = (0,_commonjsHelpers_97e6d7b1_js__WEBPACK_IMPORTED_MODULE_3__.u)(autoNumeric_min);
const InputNumberComponent = class {
  constructor(hostRef) {
    (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.inputId = `cwc-input-number-${inputIds++}`;
    this.disabledPlus = false;
    this.disabledMinus = false;
    this.plusColor = 'bright-blue';
    this.minusColor = 'bright-blue';
    this.plusHoverState = false;
    this.minusHoverState = false;
    /**
    ...
    /**
     * Units to append/prepend to the numeric input
     */

    this.unit = null;
    /**
     * defines if unit should be prepended
     */

    this.unitPrepend = false;
    /**
     * defines the character that separates teh unit from the magnitude
     */
    ...
    this.formatUnit = (unit, prepend, separator) => {
      return prepend ? unit + separator : separator + unit;
    };

    this.onChange = () => {
      const newValue = this.autoNumeric.getNumber();
      this.value = newValue;
      this.cwcChange.emit(newValue);
      this.disableButtons();
    };
    ...
    this.onBlur = ev => {
      ...
      if (this.mobile) {
        this.labelEl.classList.remove('cwc-num-input__label-mobile--focused');
      }

      this.increaseButton.classList.remove('focus');
      this.decreaseButton.classList.remove('focus');
    };
    ...
    this.onFocus = ev => {
      ...
      if (this.mobile) {
        this.labelEl.classList.add('cwc-num-input__label-mobile--focused');
      }

      this.increaseButton.classList.add('focus');
      this.decreaseButton.classList.add('focus');
    };

    this.getIconColor = (status, isHovered) => {
      const colors = {
        regular: {
          error: 'true-red',
        ...
        hover: {
          error: 'true-red-dark',
          warning: 'bright-orange-dark',
          success: 'bright-green-dark',
          regular: 'bright-blue-dark'
        }
      };
      return colors[isHovered ? 'hover' : 'regular'][status];
    };
    ...
    this.createAutoNum = () => {
      ...
      if (this.unit) {
        autoNumericOptions['currencySymbol'] = this.formatUnit(this.unit, this.unitPrepend, this.unitSeparator);
        autoNumericOptions['currencySymbolPlacement'] = this.unitPrepend ? 'p' : 's';
      }

      this.autoNumeric = new AutoNumeric(this.inputElement, this.value, autoNumericOptions);
    };
  ...
  /**
   * Method called on value prop changes
   */
  ...
  /**
   * Method called on step prop changes
   */


  setStep(newValue, oldValue) {
    if (oldValue !== newValue) {
      this.autoNumeric.options.wheelStep(newValue);
    }
  }
  ...
  /**
   * Method called on min prop changes
   */


  setMin(newValue, oldValue) {
    if (oldValue !== newValue) {
      this.autoNumeric.options.minimumValue(newValue);
    }
  }
  /**
   * Method called on min prop changes
  ...
  setMax(newValue, oldValue) {
    if (oldValue !== newValue) {
      this.autoNumeric.options.maximumValue(newValue);
    }
  }
  /**
   * Method called on decimalPlaces prop changes
   */


  setDecimalPlaces(newValue, oldValue) {
    if (oldValue !== newValue) {
      this.autoNumeric.options.decimalPlacesRawValue(newValue);
      this.autoNumeric.options.decimalPlacesShownOnFocus(newValue);
      this.autoNumeric.options.decimalPlacesShownOnBlur(newValue);
    }
  }
  /**
   * Method called on decimalSeparator prop changes
   */


  setDecimalSeparator(newValue, oldValue) {
    if (oldValue !== newValue) {
      this.autoNumeric.options.decimalCharacter(newValue);
    }
  }
  /**
   * Method called on thousandSeparator prop changes
   */


  setThousandseparator(newValue, oldValue) {
    if (oldValue !== newValue) {
      this.autoNumeric.options.digitGroupSeparator(newValue);
    }
  }

  unitPosition(newValue, oldValue) {
    if (oldValue !== newValue) {
  ...
  /**
   * Method called on unit prop changes
   */


  setUnit(newValue, oldValue) {
    if (oldValue !== newValue) {
      this.autoNumeric.remove();
      this.createAutoNum();
    }
  ...
  /**
   * Get current raw value. This is for testing purposes only and will be removed with autonumeric
   */
  ...
  getValue() {
    ...
    return (0,D_Documentos_Documentos_DocumentosPersonales_Cemex_appcemex_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this.autoNumeric.getNumber();
    })();
  }
  /**
   * Get current formatted value. This is for testing purposes only and will be removed with autonumeric
   */
  ...
  getFormattedValue() {
    ...
    return (0,D_Documentos_Documentos_DocumentosPersonales_Cemex_appcemex_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this2.autoNumeric.getFormatted();
    })();
  }
  /**
   * Increase the value by a step specified in the step prop
   */
  ...
  increase() {
    ...
    return (0,D_Documentos_Documentos_DocumentosPersonales_Cemex_appcemex_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const value = _this3.autoNumeric.getNumber() + _this3.step;

      _this3.inputElement.focus();

      if (_this3.isValueValid(value)) {
        _this3.updateValue(value);
      } else {
        _this3.updateValue(_this3.max);
      }
    })();
  }
  /**
   * Decrease the value by a step specified in the step prop
   */
  ...
  decrease() {
    ...
    return (0,D_Documentos_Documentos_DocumentosPersonales_Cemex_appcemex_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const value = _this4.autoNumeric.getNumber() - _this4.step;

      _this4.inputElement.focus();

      if (_this4.isValueValid(value)) {
        _this4.updateValue(value);
      } else {
        _this4.updateValue(_this4.min);
      }
    })();
  }
  /**
   * Reset the value to the one specified in the value prop
   */
  ...
  reset() {
    ...
    return (0,D_Documentos_Documentos_DocumentosPersonales_Cemex_appcemex_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this5.updateValue(_this5.value);
    })();
  }
  /**
  ...
  updateValue(value) {
    ...
    if (this.autoNumeric.getNumber() !== value) {
  ...
  isValueValid(newValue) {
    const valid = newValue >= this.min && newValue <= this.max;
  ...
  disableButtons() {
    this.disabledMinus = this.value <= this.min;
    this.disabledPlus = this.value >= this.max;
    this.minusHoverState = this.disabledMinus ? false : this.minusHoverState;
    this.plusHoverState = this.disabledPlus ? false : this.plusHoverState;
  }

  componentDidRender() {
    if (this.disabled) {
      this.disabledPlus = this.disabledMinus = true;
    }

    this.plusColor = this.disabledPlus ? '$disabled-grey' : this.getIconColor(this.status, this.plusHoverState);
    this.minusColor = this.disabledMinus ? '$disabled-grey' : this.getIconColor(this.status, this.minusHoverState);
  }
  ...
  render() {
    const numberComponent = (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      "aria-live": "polite",
      class: `cwc-num-input ${this.status} ${this.designVersion}`
    }, this.mobile || this.designVersion === 'v2' ? (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: this.inputId,
      class: "cwc-num-input__label-mobile",
      ...
      tabindex: "1",
      class: "cwc-form-control focusable",
      id: this.inputId,
      type: "text",
      ...
      tabindex: "-1",
      class: 'cwc-num-input__btn increase focusable' + (!this.disabledPlus ? ' ripple' : '') + ' ' + this.designVersion,
      type: "button",
      "aria-label": "increase",
      onClick: () => this.increase(),
      disabled: this.disabledPlus,
      onMouseEnter: () => {
        this.plusHoverState = true;
      },
      onMouseLeave: () => {
        this.plusHoverState = false;
      },
      ref: el => this.increaseButton = el
      ...
      tabindex: "-1",
      class: 'cwc-num-input__btn decrease focusable' + (!this.disabledMinus ? ' ripple' : '') + ' ' + this.designVersion,
      type: "button",
      "aria-label": "decrease",
      onClick: () => this.decrease(),
      disabled: this.disabledMinus,
      onMouseEnter: () => {
        this.minusHoverState = true;
      },
      onMouseLeave: () => {
        this.minusHoverState = false;
      },
      ref: el => this.decreaseButton = el
    }, (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.h)("cwc-icon", {
      designVersion: this.designVersion,
      name: "minus",
    ...
    return this.unwrap ? numberComponent : (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.h)("cwc-form-group", {
      label: this.label,
      for: this.inputId,
      ...
      mobile: this.mobile || this.designVersion === 'v2',
      designVersion: this.designVersion
    }, numberComponent);
  }
  ...
  static get watchers() {
    return {
      ...
      "unitPrepend": ["unitPosition"],
      "unit": ["setUnit"]
    };
  }

  static get style() {
    return "*{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}:host{display:inline-block}:host([disabled]) .cwc-num-input__label-mobile{background:-webkit-gradient(linear,left bottom,left top,from(var(--cwc-color-status-disabled,#d6d6d6)),color-stop(40%,var(--cwc-color-grayscale-white,#fff)),color-stop(60%,var(--cwc-color-grayscale-white,#fff)),to(hsla(0,0%,100%,0)));background:linear-gradient(0deg,var(--cwc-color-status-disabled,#d6d6d6),var(--cwc-color-grayscale-white,#fff) 40%,var(--cwc-color-grayscale-white,#fff) 60%,hsla(0,0%,100%,0))}.cwc-num-input{display:-ms-flexbox;display:flex}.cwc-num-input,.cwc-num-input input{font-family:inherit;margin:0;padding:0;-webkit-box-sizing:border-box;box-sizing:border-box;height:2.5rem}.cwc-num-input input{font-size:1rem;line-height:1rem;border:.0625rem solid var(--cwc-input-number-border-color,var(--cwc-color-elements-input-border,#adaebb));background-color:var(--cwc-input-number-background-color,var(--cwc-color-grayscale-white,#fff));display:block;width:100%;text-align:center;-ms-flex-order:2;order:2;border-left:none;border-right:none;border-inline:none;border-radius:0;-ms-flex:1 1 auto;flex:1 1 auto;-moz-appearance:textfield;-webkit-appearance:none}.cwc-num-input input::-webkit-inner-spin-button,.cwc-num-input input::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}.cwc-num-input input:active,.cwc-num-input input:focus{outline:0 none;border-color:var(--cwc-input-number-focus-border-color,var(--cwc-color-links,#3fa9f5));background:var(--cwc-input-number-focus-background-color,var(--cwc-color-grayscale-white,#fff))}.cwc-num-input input:disabled{background-color:var(--cwc-input-number-disabled-background-color,var(--cwc-color-status-disabled,#d6d6d6));opacity:1}.cwc-num-input input:disabled:active,.cwc-num-input input:disabled:focus{border-color:var(--cwc-input-number-disabled-focus-border-color,var(--cwc-color-elements-input-border,#adaebb))}.cwc-num-input input::-webkit-input-placeholder{color:var(--cwc-input-number-placeholder-color,var(--cwc-color-grayscale-medium,#666));font-size:1rem}.cwc-num-input input::-moz-placeholder{color:var(--cwc-input-number-placeholder-color,var(--cwc-color-grayscale-medium,#666));font-size:1rem}.cwc-num-input input:-ms-input-placeholder{color:var(--cwc-input-number-placeholder-color,var(--cwc-color-grayscale-medium,#666));font-size:1rem}.cwc-num-input input:-moz-placeholder{color:var(--cwc-input-number-placeholder-color,var(--cwc-color-grayscale-medium,#666));font-size:1rem}[dir=ltr] .cwc-num-input__label-mobile{left:48px}[dir=rtl] .cwc-num-input__label-mobile{right:48px}.cwc-num-input__label-mobile{position:absolute;inset-inline-start:48px;color:var(--cwc-input-number-label-mobile-color,var(--cwc-color-grayscale-medium,#666));border-radius:3px;pointer-events:none;z-index:1;font-size:.75rem;line-height:.75rem;top:-6px;padding:0 2px;background:-webkit-gradient(linear,left bottom,left top,color-stop(50%,var(--cwc-color-grayscale-white,#fff)),to(hsla(0,0%,100%,0)));background:linear-gradient(0deg,var(--cwc-color-grayscale-white,#fff) 50%,hsla(0,0%,100%,0))}.cwc-num-input__label-mobile--focused{color:var(--cwc-input-number-label-mobile-focused-color,var(--cwc-color-links,#3fa9f5))}.cwc-num-input__label-mobile .required{color:var(--cwc-input-number-label-mobile-required-color,var(--cwc-color-status-error,#ee3d42))}.cwc-num-input__btn{width:2.5rem;fill:var(--cwc-input-number-btn-fill,var(--cwc-color-links,#3fa9f5));display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;border-color:var(--cwc-input-number-btn-border-color,var(--cwc-color-elements-input-border,#adaebb));border-style:solid;border-width:.0625rem;height:2.5rem;background-color:var(--cwc-input-number-btn-background-color,var(--cwc-color-grayscale-white,#fff));-webkit-box-sizing:border-box;box-sizing:border-box;overflow:hidden}.cwc-num-input__btn:disabled{background-color:var(--cwc-input-number-btn-disabled-background-color,var(--cwc-color-status-disabled,#d6d6d6));fill:var(--cwc-input-number-btn-disabled-fill,var(--cwc-color-elements-input-border,#adaebb));cursor:default}.cwc-num-input__btn:disabled>cwc-icon{cursor:default}.cwc-num-input__btn:focus{outline:none}.cwc-num-input__btn:hover{cursor:pointer}.cwc-num-input__btn>span{line-height:1.75rem;pointer-events:none}[dir=ltr] .cwc-num-input__btn.decrease{border-top-left-radius:.1875rem}[dir=rtl] .cwc-num-input__btn.decrease{border-top-right-radius:.1875rem}[dir=ltr] .cwc-num-input__btn.decrease{border-top-right-radius:0}[dir=rtl] .cwc-num-input__btn.decrease{border-top-left-radius:0}[dir=ltr] .cwc-num-input__btn.decrease{border-bottom-left-radius:.1875rem}[dir=rtl] .cwc-num-input__btn.decrease{border-bottom-right-radius:.1875rem}[dir=ltr] .cwc-num-input__btn.decrease{border-bottom-right-radius:0}[dir=rtl] .cwc-num-input__btn.decrease{border-bottom-left-radius:0}.cwc-num-input__btn.decrease{-ms-flex-order:1;order:1;border-start-start-radius:.1875rem;border-start-end-radius:0;border-end-start-radius:.1875rem;border-end-end-radius:0}[dir=ltr] .cwc-num-input__btn.decrease.v2{border-top-left-radius:8px}[dir=rtl] .cwc-num-input__btn.decrease.v2{border-top-right-radius:8px}[dir=ltr] .cwc-num-input__btn.decrease.v2{border-bottom-left-radius:8px}[dir=rtl] .cwc-num-input__btn.decrease.v2{border-bottom-right-radius:8px}.cwc-num-input__btn.decrease.v2{border-start-start-radius:8px;border-end-start-radius:8px}[dir=ltr] .cwc-num-input__btn.increase{border-top-left-radius:0}[dir=rtl] .cwc-num-input__btn.increase{border-top-right-radius:0}[dir=ltr] .cwc-num-input__btn.increase{border-top-right-radius:.1875rem}[dir=rtl] .cwc-num-input__btn.increase{border-top-left-radius:.1875rem}[dir=ltr] .cwc-num-input__btn.increase{border-bottom-left-radius:0}[dir=rtl] .cwc-num-input__btn.increase{border-bottom-right-radius:0}[dir=ltr] .cwc-num-input__btn.increase{border-bottom-right-radius:.1875rem}[dir=rtl] .cwc-num-input__btn.increase{border-bottom-left-radius:.1875rem}.cwc-num-input__btn.increase{-ms-flex-order:3;order:3;border-start-start-radius:0;border-start-end-radius:.1875rem;border-end-start-radius:0;border-end-end-radius:.1875rem}[dir=ltr] .cwc-num-input__btn.increase.v2{border-top-right-radius:8px}[dir=rtl] .cwc-num-input__btn.increase.v2{border-top-left-radius:8px}[dir=ltr] .cwc-num-input__btn.increase.v2{border-bottom-right-radius:8px}[dir=rtl] .cwc-num-input__btn.increase.v2{border-bottom-left-radius:8px}.cwc-num-input__btn.increase.v2{border-start-end-radius:8px;border-end-end-radius:8px}.cwc-num-input__btn.ripple{-webkit-transform:translateZ(0);transform:translateZ(0)}[dir=ltr] .cwc-num-input__btn.ripple:after{left:0}[dir=ltr] .cwc-num-input__btn.ripple:after,[dir=rtl] .cwc-num-input__btn.ripple:after{right:0}[dir=rtl] .cwc-num-input__btn.ripple:after{left:0}.cwc-num-input__btn.ripple:after{content:\"\";display:block;position:absolute;top:0;inset-inline-start:0;inset-inline-end:0;bottom:0;pointer-events:none;background-image:radial-gradient(circle,rgba(0,0,0,.25) 10%,hsla(0,0%,100%,0) 10.01%);background-repeat:no-repeat;background-position:50%;-webkit-transform:scale(10);transform:scale(10);opacity:0;-webkit-transition:opacity 1s,-webkit-transform .5s;transition:opacity 1s,-webkit-transform .5s;transition:transform .5s,opacity 1s;transition:transform .5s,opacity 1s,-webkit-transform .5s}.cwc-num-input__btn.ripple:active:after{-webkit-transform:scale(0);transform:scale(0);opacity:.3;-webkit-transition:0s;transition:0s}.cwc-num-input__btn.focus{border-color:var(--cwc-input-number-btn-focus-border-color,var(--cwc-color-links,#3fa9f5))}.cwc-num-input.error input{border-color:var(--cwc-input-number-error-border-color,var(--cwc-color-status-error,#ee3d42));background-color:var(--cwc-input-number-error-background-color,var(--cwc-color-status-error-alpha-five,rgba(238,61,66,.05)))}.cwc-num-input.error input:active,.cwc-num-input.error input:focus{border-color:var(--cwc-input-number-error-focus-border-color,var(--cwc-color-status-error-dark,#b71c1c));background-color:var(--cwc-input-number-error-focus-border-color,var(--cwc-color-status-error-alpha-five,rgba(238,61,66,.05)))}.cwc-num-input.error .cwc-num-input__btn{border-color:var(--cwc-input-number-error-btn-border-color,var(--cwc-color-status-error,#ee3d42));fill:var(--cwc-input-number-error-btn-fill,var(--cwc-color-status-error,#ee3d42));background-color:var(--cwc-input-number-error-btn-background-color,var(--cwc-color-status-error-alpha-five,rgba(238,61,66,.05)))}.cwc-num-input.error .cwc-num-input__btn.focus{border-color:var(--cwc-input-number-error-focus-border-color,var(--cwc-color-status-error-dark,#b71c1c))}.cwc-num-input.error label.cwc-num-input__label-mobile{color:var(--cwc-input-number-error-label-mobile-color,var(--cwc-color-status-error,#ee3d42));background:-webkit-gradient(linear,left bottom,left top,from(var(--cwc-color-status-error-alpha-five,rgba(238,61,66,.05))),color-stop(40%,var(--cwc-color-grayscale-white,#fff)),color-stop(60%,var(--cwc-color-grayscale-white,#fff)),to(hsla(0,0%,100%,0)));background:linear-gradient(0deg,var(--cwc-color-status-error-alpha-five,rgba(238,61,66,.05)),var(--cwc-color-grayscale-white,#fff) 40%,var(--cwc-color-grayscale-white,#fff) 60%,hsla(0,0%,100%,0))}.cwc-num-input.error label.cwc-num-input__label-mobile--focused{color:var(--cwc-input-number-error-label-mobile-focused-color,var(--cwc-color-status-error-dark,#b71c1c))}.cwc-num-input.warning input{border-color:var(--cwc-input-number-warning-border-color,var(--cwc-color-status-warning,#fbb03b));background-color:var(--cwc-input-number-warning-background-color,var(--cwc-color-status-warning-alpha-five,rgba(251,176,59,.05)))}.cwc-num-input.warning input:active,.cwc-num-input.warning input:focus{border-color:var(--cwc-input-number-warning-focus-border-color,var(--cwc-color-status-warning-dark,#ff8f00));background-color:var(--cwc-input-number-warning-focus-border-color,var(--cwc-color-status-warning-alpha-five,rgba(251,176,59,.05)))}.cwc-num-input.warning .cwc-num-input__btn{border-color:var(--cwc-input-number-warning-btn-border-color,var(--cwc-color-status-warning,#fbb03b));fill:var(--cwc-input-number-warning-btn-fill,var(--cwc-color-status-warning,#fbb03b));background-color:var(--cwc-input-number-warning-btn-background-color,var(--cwc-color-status-warning-alpha-five,rgba(251,176,59,.05)))}.cwc-num-input.warning .cwc-num-input__btn.focus{border-color:var(--cwc-input-number-warning-btn-focus-border-color,var(--cwc-color-status-warning-dark,#ff8f00))}.cwc-num-input.warning label.cwc-num-input__label-mobile{color:var(--cwc-input-number-warning-label-mobile-color,var(--cwc-color-status-warning,#fbb03b));background:-webkit-gradient(linear,left bottom,left top,from(var(--cwc-color-status-warning-alpha-five,rgba(251,176,59,.05))),color-stop(40%,var(--cwc-color-grayscale-white,#fff)),color-stop(60%,var(--cwc-color-grayscale-white,#fff)),to(hsla(0,0%,100%,0)));background:linear-gradient(0deg,var(--cwc-color-status-warning-alpha-five,rgba(251,176,59,.05)),var(--cwc-color-grayscale-white,#fff) 40%,var(--cwc-color-grayscale-white,#fff) 60%,hsla(0,0%,100%,0))}.cwc-num-input.warning label.cwc-num-input__label-mobile--focused{color:var(--cwc-input-number-warning-label-mobile-focused-color,var(--cwc-color-status-warning-dark,#ff8f00))}.cwc-num-input.success input{border-color:var(--cwc-input-number-success-border-color,var(--cwc-color-status-success,#7ac943));background-color:var(--cwc-input-number-success-background-color,var(--cwc-color-status-success-alpha-five,rgba(122,201,67,.05)))}.cwc-num-input.success input:active,.cwc-num-input.success input:focus{border-color:var(--cwc-input-number-success-focus-border-color,var(--cwc-color-status-success-dark,#1b5e20));background-color:var(--cwc-input-number-success-focus-background-color,var(--cwc-color-status-success-focus-alpha-five,rgba(122,201,67,.05)))}.cwc-num-input.success .cwc-num-input__btn{border-color:var(--cwc-input-number-success-btn-border-color,var(--cwc-color-status-success,#7ac943));fill:var(--cwc-input-number-success-btn-fill,var(--cwc-color-status-success,#7ac943));background-color:var(--cwc-input-number-success-btn-background-color,var(--cwc-color-status-success-alpha-five,rgba(122,201,67,.05)))}.cwc-num-input.success .cwc-num-input__btn.focus{border-color:var(--cwc-input-number-success-btn-focus-background-color,var(--cwc-color-status-success-dark,#1b5e20))}.cwc-num-input.success label.cwc-num-input__label-mobile{color:var(--cwc-input-number-success-label-mobile-color,var(--cwc-color-status-success,#7ac943));background:-webkit-gradient(linear,left bottom,left top,from(var(--cwc-color-status-success-alpha-five,rgba(122,201,67,.05))),color-stop(40%,var(--cwc-color-grayscale-white,#fff)),color-stop(60%,var(--cwc-color-grayscale-white,#fff)),to(hsla(0,0%,100%,0)));background:linear-gradient(0deg,var(--cwc-color-status-success-alpha-five,rgba(122,201,67,.05)),var(--cwc-color-grayscale-white,#fff) 40%,var(--cwc-color-grayscale-white,#fff) 60%,hsla(0,0%,100%,0))}.cwc-num-input.success label.cwc-num-input__label-mobile--focused{color:var(--cwc-input-number-success-label-mobile-focused-color,var(--cwc-color-status-success-dark,#1b5e20))}\@media (hover:hover){:host([disabled]) .cwc-num-input__label-mobile{color:var(--cwc-input-number-label-mobile-disabled-hover-color,var(--cwc-color-grayscale-medium,#666))}.cwc-num-input:hover>:not(:disabled){border-color:var(--cwc-input-number-hover-border-color,var(--cwc-color-links,#3fa9f5))!important}.cwc-num-input:hover>label{color:var(--cwc-input-number-hover-color,var(--cwc-color-links,#3fa9f5))}.cwc-num-input.error:hover>label{color:var(--cwc-input-number-error-label-hover-color,var(--cwc-color-status-error-dark,#b71c1c))}.cwc-num-input.warning input:hover{border-color:var(--cwc-input-number-warning-hover-border-color,var(--cwc-color-status-warning-dark,#ff8f00));background-color:var(--cwc-input-number-warning-hover-background-color,var(--cwc-color-status-warning-alpha-five,rgba(251,176,59,.05)))}.cwc-num-input.warning:hover>label{color:var(--cwc-input-number-warning-label-hover-color,var(--cwc-color-status-warning-dark,#ff8f00))}.cwc-num-input.success input:hover{border-color:var(--cwc-input-number-success-hover-border-color,var(--cwc-color-status-success-dark,#1b5e20));background-color:var(--cwc-input-number-success-hover-background-color,var(--cwc-color-status-success-alpha-five,rgba(122,201,67,.05)))}.cwc-num-input.success:hover>label{color:var(--cwc-input-number-success-label-hover-color,var(--cwc-color-status-success-dark,#1b5e20))}.cwc-num-input input:hover{outline:0 none;border-color:var(--cwc-input-number-hover-border-color,var(--cwc-color-links,#3fa9f5));background-color:var(--cwc-input-number-hover-background-color,var(--cwc-color-grayscale-white,#fff))}.cwc-num-input input:disabled:hover{background-color:var(--cwc-input-number-disabled-hover-background-color,var(--cwc-color-status-disabled,#d6d6d6));border-color:var(--cwc-input-number-disabled-hover-border-color,var(--cwc-color-elements-input-border,#adaebb))}.cwc-num-input.error:hover>:not(:disabled){border-color:var(--cwc-input-number-error-hover-border-color,var(--cwc-color-status-error-dark,#b71c1c))!important}.cwc-num-input.error:hover>:not(:disabled) span{color:var(--cwc-input-number-error-message-color,var(--cwc-color-status-error-dark,#b71c1c))!important}.cwc-num-input.error input:hover{border-color:var(--cwc-input-number-error-hover-border-color,var(--cwc-color-status-error-dark,#b71c1c));background-color:var(--cwc-input-number-error-hover-background-color,var(--cwc-color-status-error-alpha-five,rgba(238,61,66,.05)))}.cwc-num-input.warning:hover>:not(:disabled){border-color:var(--cwc-input-number-warning-border-color,var(--cwc-color-status-warning-dark,#ff8f00))!important}.cwc-num-input.warning:hover>:not(:disabled) span{color:var(--cwc-input-number-warning-message-hover-color,var(--cwc-color-status-warning-dark,#ff8f00))!important}.cwc-num-input.warning input:hover{border-color:var(--cwc-input-number-warning-border-color,var(--cwc-color-status-warning-dark,#ff8f00));background-color:var(--cwc-input-number-warning-background-color,var(--cwc-color-status-warning-alpha-five,rgba(251,176,59,.05)))}.cwc-num-input.success:hover>:not(:disabled){border-color:var(--cwc-input-number-success-border-color,var(--cwc-color-status-success-dark,#1b5e20))!important}.cwc-num-input.success:hover>:not(:disabled) span{color:var(--cwc-input-number-success-message-hover-color,var(--cwc-color-status-success-dark,#1b5e20))!important}.cwc-num-input.success input:hover{border-color:var(--cwc-input-number-success-border-color,var(--cwc-color-status-success-dark,#1b5e20));background-color:var(--cwc-input-number-success-background-color,var(--cwc-color-status-success-alpha-five,rgba(122,201,67,.05)))}}";
  }
...
//# sourceMappingURL=node_modules_cmx-web-components_core_dist_esm_cwc-input-number_entry_js.js.map