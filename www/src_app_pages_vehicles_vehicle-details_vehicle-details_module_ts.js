...
let VehicleDetailsPage = class VehicleDetailsPage {
    constructor(location, vehiclesService, loginService, navCtrl, driversService) {
        ...
        this.driverList = [];
        this.idAdmin = '0h174cfb–4418–1c3e-a2bf-89f716w72cu3';
