"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_pages_vehicles_update-vehicle_update-vehicle_module_ts"],{

/***/ 31287:
/*!********************************************************************************!*\
  !*** ./src/app/pages/vehicles/update-vehicle/update-vehicle-routing.module.ts ***!
  \********************************************************************************/
...
/* harmony import */ var _update_vehicle_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./update-vehicle.page */ 43366);
...
/***/ 76748:
/*!************************************************************************!*\
  !*** ./src/app/pages/vehicles/update-vehicle/update-vehicle.module.ts ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _update_vehicle_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./update-vehicle-routing.module */ 31287);
/* harmony import */ var _update_vehicle_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./update-vehicle.page */ 43366);
...
UpdateVehiclePageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/***/ 43366:
/*!**********************************************************************!*\
  !*** ./src/app/pages/vehicles/update-vehicle/update-vehicle.page.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _update_vehicle_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./update-vehicle.page.html?ngResource */ 3059);
/* harmony import */ var _update_vehicle_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./update-vehicle.page.scss?ngResource */ 77109);
...
/* harmony import */ var _models_vehicle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/vehicle */ 56192);
...
let UpdateVehiclePage = class UpdateVehiclePage {
    constructor(formBuilder, companiesService, errorMessages, vehiclesService, location, loginService) {
    ...
    ngOnInit() {
        ...
        this.companiesService.getCompany(this.loginService.profileUser.CompanyId).subscribe((data) => (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
    ...
    updateVehicle() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.vehiclesService.updateVehicle(this.vehicle.id, this.data).subscribe((resp) => (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
    ...
    formBuilderInput() {
        this.form = this.formBuilder.group({
            Model: [this.vehicle.model, [_angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required]],
            LicenseVehiculo: [this.vehicle.licenseVehiculo, [_angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required]],
            TypeTrailer: [this.vehicle.typeTrailer, [_angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required]],
            CompanyId: [this.loginService.profileUser.CompanyId, [_angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required]],
            Soat: [this.vehicle.soat, [_angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required]],
...
UpdateVehiclePage = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
...
/***/ 77109:
/*!***********************************************************************************!*\
  !*** ./src/app/pages/vehicles/update-vehicle/update-vehicle.page.scss?ngResource ***!
  \***********************************************************************************/
/***/ ((module) => {

module.exports = ".header-text {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  position: fixed;\n  top: 1;\n  right: 50;\n  left: 0;\n  margin-left: 1rem;\n}\n\n.attr-name {\n  font-weight: 700;\n}\n\n.content-card {\n  padding-top: 0.5rem;\n  padding-left: 1rem;\n  padding-right: 1rem;\n  padding-bottom: 1rem;\n  flex: 1 1 auto;\n  overflow: auto;\n}\n\n.content-grid-register {\n  overflow: auto;\n  justify-content: center !important;\n}\n\n.content-title {\n  padding-top: 1rem;\n  padding-bottom: 1.5rem;\n  font-weight: 700;\n}\n\n.content-picker {\n  padding-bottom: 1.5rem;\n}\n\n.input-check {\n  font-size: small;\n  padding-bottom: 2rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 3059:
/*!***********************************************************************************!*\
  !*** ./src/app/pages/vehicles/update-vehicle/update-vehicle.page.html?ngResource ***!
  \***********************************************************************************/
/***/ ((module) => {

module.exports = "<cwc-header design-version=\"v2\" slot=\"header\" show-Menu-Button=\"false\" show-cemex-logo=\"false\">\r\n  <div class=\"header-text\">\r\n    <ion-icon name=\"arrow-back-outline\" style=\"font-size: 25px;\" (click)=\"onBack()\"></ion-icon>\r\n    <div class=\"attr-name\" style=\"padding-left: 1rem;\">Editar vehículo</div>\r\n  </div>\r\n</cwc-header>\r\n<div slot=\"main\" class=\"content-card\">  \r\n  <div class=\"content-title\">\r\n    Mi vehículo\r\n  </div>\r\n  <form (submit)=\"updateVehicle()\" [formGroup]=\"form\">\r\n    <cwc-grid class=\"demo-grid\" design-version=\"v2\" columns=\"12\" mobile-columns=\"12\">\r\n      <cwc-cell colspan=\"12\" mobile-colspan=\"12\">\r\n        <div>\r\n          <cwc-input class=\"input\" \r\n            label='Medelo de vehículo'\r\n            placeholder=\"Agrega el tipo de camión\"\r\n            design-version=\"v1\" \r\n            formControlName=\"Model\"\r\n            required\r\n          ></cwc-input>\r\n        </div>\r\n        <div>\r\n          <cwc-input class=\"input\" \r\n            label='Placa'\r\n            formControlName=\"LicenseVehiculo\"\r\n            design-version=\"v1\"\r\n            placeholder=\"Agrega número de serie\"\r\n            required\r\n          ></cwc-input>\r\n        </div>\r\n        <div>\r\n          <cwc-input class=\"input\" \r\n            label='Tipo de trailer'\r\n            formControlName=\"TypeTrailer\"\r\n            placeholder=\"Características especiales del vehículo\"\r\n            design-version=\"v1\" \r\n            required\r\n          ></cwc-input>\r\n        </div>\r\n        <div class=\"content-picker\" *ngIf=\"company\">\r\n          <cwc-picker\r\n            class=\"w-full select-filter\"\r\n            label=\"Empresa\"\r\n            filter-no-resultsMessage=\"No se encontraron resultados\" \r\n            filter-placeholder=\"Filtrar Empresas\"\r\n            [placeholder]=\"company.companyName\" \r\n            mobile=\"false\"\r\n            disabled=\"true\"\r\n            string-values=\"true\"\r\n            filter>\r\n          </cwc-picker>\r\n        </div>\r\n        <div class=\"section\">\r\n          <cwc-input class=\"input\" \r\n          label='Número de SOAT (opcional)'\r\n          type=\"text\"\r\n          formControlName=\"Soat\"\r\n          placeholder=\"Agregar los 20 dígitos de su número de SOAT\"\r\n          design-version=\"v1\" \r\n          ngDefaultControl\r\n          required\r\n          ></cwc-input>\r\n        </div>\r\n      </cwc-cell>\r\n    </cwc-grid>\r\n    <cwc-checkbox\r\n      formControlName=\"term\"\r\n      mobile=\"true\"\r\n      class='m-end-sm'>          \r\n      <div class=\"input-check\">Confirmo que la siguiente información es verdadera.</div>\r\n    </cwc-checkbox>\r\n\r\n    <app-error-messages [errors]=\"errors\"></app-error-messages> \r\n    <!--=====================================\r\n      BOTON PARA GUARDAR EL REGISTRO\r\n    ======================================-->\r\n    <div class=\"content-button\">\r\n      <cwc-button \r\n        design-version=\"v1\" \r\n        [disabled]=\"form.invalid\"\r\n        (click)=\"openAlertConfirm()\" \r\n        variant=\"regular-block\">GUARDAR CAMBIOS</cwc-button>\r\n    </div>\r\n  </form>\r\n</div>\r\n<!--=====================================\r\n\t\tMODAL ALERTA CONFIRMAR DATOS GUARDAR\r\n======================================-->\r\n<cwc-modal id='alert-confirm' class=\"alert-confirm\" [open] =\"alertConfirm\" (cwcClose)=\"closeAlertConfirm()\">\r\n  <header slot='header'>\r\n      <h2 style='margin:0;'>Atención</h2>\r\n  </header>\r\n  <p>¿Esta seguro que los datos registrados estan correctos?</p>\r\n  <footer slot='footer'>\r\n      <div style='text-align: end'>\r\n        <cwc-button variant='support' (click)=\"closeAlertConfirm()\" style=\"margin-right: 1rem;\">Cancelar</cwc-button>\r\n          <cwc-button variant='primary' (click)=\"updateVehicle()\" >Aceptar</cwc-button>\r\n      </div>\r\n  </footer>\r\n</cwc-modal>\r\n<!--=====================================\r\n\t\tMODAL CONFIRMACIÓN RESPUESTA DE EXITO\r\n======================================-->\r\n<app-alert-success\r\n  [alertShow] = \"alertSucces\"\r\n  title = \"Su información ha sido guardada\"\r\n  urlButton = \"/app/vehiculos/detalles\"\r\n  textButton = \"OK\"\r\n  message = \"El vehiculo fue actualizado correctamente.\">\r\n</app-alert-success>\r\n<!--=====================================\r\n\tTOAST ALERT MENSAJE\r\n======================================-->\r\n<cwc-snackbar id='toast-message-driver' [message]=\"toastMessage\"\r\ncta-message=\"dismiss\" auto-hide-duration='5000'></cwc-snackbar>\r\n";

/***/ })

}]);
//# sourceMappingURL=src_app_pages_vehicles_update-vehicle_update-vehicle_module_ts.js.map