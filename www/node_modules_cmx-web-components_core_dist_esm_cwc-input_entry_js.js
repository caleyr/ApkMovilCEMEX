"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_cmx-web-components_core_dist_esm_cwc-input_entry_js"],{

/***/ 63312:
/*!***************************************************************************!*\
  !*** ./node_modules/@cmx-web-components/core/dist/esm/cwc-input.entry.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "cwc_input": () => (/* binding */ InputText)
/* harmony export */ });
...
const InputText = class {
  constructor(hostRef) {
    ...
    this.valueCheck = () => {
      this.empty = this.value === null || this.value === '' || this.value === undefined ? true : false;
    };
  ...
  render() {
    ...
    const inputComponent = (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, this.renderIconStyles(this.leadingIcon, this.trailingIcon), (0,_core_cf426fab_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      name: this.name,
      value: this.value,
      placeholder: this.mobile ? this.unwrap ? this.placeholder : null : this.placeholder,
      disabled: this.disabled,
      required: this.required,
      autoComplete: this.autocomplete,
      autoCorrect: this.autocorrect,
...
//# sourceMappingURL=node_modules_cmx-web-components_core_dist_esm_cwc-input_entry_js.js.map